...
export async function GET() {
  const baseUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.star-wars-galactic-racer.wiki'
  const siteName = process.env.NEXT_PUBLIC_SITE_NAME || 'STAR WARS: Galactic Racer Wiki'
