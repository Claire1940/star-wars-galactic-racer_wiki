...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - STAR WARS: Galactic Racer Wiki",
    description: "Read the Terms of Service for STAR WARS: Galactic Racer Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our racing game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - STAR WARS: Galactic Racer Wiki",
      description: "Terms and conditions for using STAR WARS: Galactic Racer Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using STAR WARS: Galactic Racer Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using STAR WARS: Galactic Racer Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and STAR WARS: Galactic Racer Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              STAR WARS: Galactic Racer Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the racing game "STAR WARS: Galactic Racer". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Release date, platform, and pre-order guides</li>
              <li>Vehicle and build customization guides</li>
              <li>Track, planet, and location information</li>
              <li>Game mode and multiplayer explainers</li>
              <li>Edition comparison and PC system requirements</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> STAR WARS: Galactic Racer Wiki is NOT affiliated with, endorsed by, or associated with
              Lucasfilm Ltd., LLC, The Walt Disney Company, or the official developers and publishers of STAR WARS: Galactic Racer. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by STAR WARS: Galactic Racer Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Lucasfilm Ltd., LLC and/or the official developers and publishers of STAR WARS: Galactic Racer. We use such
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, STAR WARS: GALACTIC RACER WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and STAR WARS: Galactic Racer Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@star-wars-galactic-racer.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@star-wars-galactic-racer.wiki</a>
            </p>
            <p>
