...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - STAR WARS: Galactic Racer Wiki',
    description: 'STAR WARS: Galactic Racer Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our racing game resource platform. Your privacy matters to us.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              STAR WARS: Galactic Racer Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              STAR WARS: Galactic Racer Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with Lucasfilm Ltd., LLC or the official developers and publishers of STAR WARS: Galactic Racer. All game content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@star-wars-galactic-racer.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@star-wars-galactic-racer.wiki</a>
            </p>
            <p>
