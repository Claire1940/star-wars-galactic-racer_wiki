...
export default function HomePageClient({
    ...
    "@graph": [
      ...
      },
      {
        ...
        image: {
          ...
          width: 1920,
          height: 1080,
          caption: "STAR WARS: Galactic Racer Wiki - Outer Rim Racing Adventure",
        },
        sameAs: [
          ...
          "https://www.instagram.com/starwarsgalacticracer/",
      ...
      {
        "@type": "VideoObject",
        name: "STAR WARS: Galactic Racer - Official Gameplay Trailer",
        description:
          "Official STAR WARS: Galactic Racer gameplay trailer showcasing Outer Rim racing, podracers, landspeeders, speeder bikes, and skim speeders.",
        uploadDate: "2026-06-23",
        thumbnailUrl: `${siteUrl}/images/hero.webp`,
        embedUrl: "https://www.youtube.com/embed/scnYJ0afMxM",
        url: "https://www.youtube.com/watch?v=scnYJ0afMxM",
      },
    ],
  };
  ...
  return (
    <div className="home-shell min-h-screen bg-background text-foreground">
      ...
      {/* Video Section - 紧跟 Hero 区域（官方 Gameplay Trailer） */}
